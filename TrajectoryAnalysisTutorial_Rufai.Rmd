...
To check the projection of your country of interest, you can use [EPSG.io](https://epsg.io/)
```{r echo=TRUE}
mahakam_rasters <- list(ras1999, ras2014, ras2018, ras2020, ras2022)
for (i in seq_along(mahakam_rasters)) {
...
```
It is not clear from this what the Coordinate Reference System is, hence we will assign the CRS for the Mahakam Delta to each of our data input to ensure they overlap properly.
